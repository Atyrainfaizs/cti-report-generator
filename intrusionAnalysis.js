document.getElementById('intrusionForm').addEventListener('submit', function(event) {
    ...
    const indicatorAnalysis = document.getElementById('indicatorAnalysis').value;
    ...
    saveReport(report);
    alert('Intrusion Analysis Report Saved!');
